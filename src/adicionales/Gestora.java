...
public class Gestora {
	 ...
	 * 
	 * Comentario: Este método se encarga de preguntar al usuario si desea coger un objeto y si es así se guardara en el inventario y si 
         * no se podrá tirar otro objeto para hacer sitio al nuevo objeto
	 * 
	 * Entradas: Objeto objeto, Jugador usuario
	 * 
	 * Salidas:Ninguna 
	 * 
	 * Precondiciones: Ninguna
	 * 
	 * Postcondiciones:Este método se trata de un procedimiento 
	 * 
	 */
	 ...
	 * 
	 * Comentario: Este método se encarga de realizar un combate entre el usuario y un enemigo que solo acabara cuando
	 *la vida de alguno de los dos llegue a 0
	 * 
	 * Entradas:Personaje enemigo,Jugador usuario  
	 * 
	 * Salidas:Ninguna 
	 * 
	 * Precondiciones:Ninguna 
