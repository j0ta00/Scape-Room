...
public class Main {
	...
	public static void main(String[] args) {
		...
		Personaje zombie = null,zombieTullido = null, plantaCarnivora = null;
			...
			case 4://Opcion ir a la gasolinera
				...
				do{
					...
					case 3://Opcion Mirar coche en mal estado
						...
						System.out.println("Parece que intento huir de la ciudad pero se choco \n"
								+ "por desgracia ninguna de las piezas del vehículo te servirían");
						if(cocheDestruidoRevisado==false) {
							System.out.println("¿Quieres registrar el interior del vehículo a ver si contiene algo?");
							respuesta = validacion.leerValidarRespuesta();
							
							if(respuesta=='S') {
								zombieTullido = new Personaje("ZombieTullido",10,20);
								System.out.println("Ha salido un "+zombieTullido.getNombre()+" justo al abrir las puertas del coche");	
								Gestora.combateJugadorEnemigo(zombieTullido, usuario);
						...
						do {
							...
							case 2://Revisar Puerta Extraña
								...
								if(respuesta=='S') {
									...
									System.out.println("No hay nada, ya no queda nada interesante que hacer aquí");
