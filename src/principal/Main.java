...
public class Main {
	...
	public static void main(String[] args) {
		...
		int opcionInicial = 0, opcionCementerio = 0, opcionTumbas = 0, opcionGasolinera = 0,opcionAlmacen=0, opcionJardin = 0, opcionGaraje = 0, opcionMansion = 0, opcionDormitorio = 0;
		int objetosMision = 0, ataqueUsuario = 0, ataqueEnemigo = 0, posicionMochila = 0;
		boolean tumba1 = false,palancaActivada = false ,tumba2 = false, tumba3 = false,cajasApartadas=false, cuartillo = false, cocina = false, cocheHuida = false;
		char respuesta =' ';
		String nombre = " ";
							...
							case 2: //Tumba 2
								...
								if(usuario.consultarObjetosNecesarioMochila("Pala") && tumba2 == false) {
									...
									do {
										...
										zombie.recibirDanho(ataqueUsuario);
			...
			case 4://Opcion ir a la gasolinera
				...
				do{
					...
					switch(opcionGasolinera) {
						...
						break;
						case 3://Mirar Almacén
							do {
							//LeerYValidarOpcionesAlmacenGasolinera
							opcionAlmacen=validacion.mostrarLeerValidarOpcionesAlmacenGasolinera();
							switch(opcionAlmacen) {
								case 1://Registrar Zona
									if(palancaActivada == false) {
										//Opcion Apartar las cajas
										if(cajasApartadas==false){
										...
										if(cajasApartadas==true && usuario.getVida()>0) {
